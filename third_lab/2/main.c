...
int main() {
    ...
    switch (search_longest_vectors(&res, &count_res, 3, 3, v_1, v_2, v_2, a_norm,
     &matrix_A, inf_norm, NULL, p_norm, &p)) {
        ...
        case INVALID_INPUT:
            ...
            delete_vector_arr(&res, count_res);
            return MEMORY_ALLOCATION_ERROR;
        case DEREFERENCING_NULL_POINTER_ATTEMPT:
            printf("Null pointer error\n");
            delete_vector_arr(&res, count_res);
            return DEREFERENCING_NULL_POINTER_ATTEMPT;
        case FILE_PATH_LENGTH_ERROR:
